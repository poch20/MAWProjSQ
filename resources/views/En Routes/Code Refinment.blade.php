...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <h1 class="edwinDiazCourse">Master Title</h1>
        <div class="container">

          <section class="sectionDivisions">
            <h1 class="masterBoxTitleSection">Title Section</h1>
            <p>
              <pre>
                <strong class="ProceduralProcessBoxTitle"></strong>:<b><em class="steprocedure"></em></b>
                    <strong class="methodanicompute"></strong><b></b>
          ...
          <section class="sectionDivisions">
            <h1 class="masterBoxTitleSection">Title Section</h1>
            <p>
              <h4 class="moduleContentBoxTitle">Content Title</h4>
              <pre>
