      ...
      <h1 class="edwinDiazCourse">PHP with Laravel for beginners - Become a Master in Laravel</h1>
        <div class="container">
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">===Section 2: Windows - Local Environment Setup===</h1>
            <p>
              <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 4: Laravel Fundamentals</h1>
            <p>
              <h4 class="MasterBoxTitle">===Routes===</h4>
              <pre>
                <b>
                  Route::get('/', function () {
                      return view('welcome');
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">===Section 5: Laravel Fundamentals - Controllers===</h1>
            <p>
              <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 6: Laravel Fundamentals</h1>
            <p>
              <h4 class="MasterBoxTitle">====Views 27. Passing data to views====</h4>
              <pre>
                <strong class="ProceduralProcessBoxTitle">step 1</strong>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">===Section 7: Laravel Fundamentals - Laravel Blade templating engine===</h1>
            <div class="section11">
              <p>
                <h1 class="MasterBoxTitle">===29. Master layout setup===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===Section 7: Laravel Fundamentals - Laravel Blade templating engine 30. Some more blade features===</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 8: Laravel Fundamentals - Database - Laravel Migrations</h1>
            <div class="section11">
              <p>
                <h1 class="MasterBoxTitle">===33. New - Windows OS - Migrations===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">====== 35. Creating migrations and dropping them===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">======37. Some more migration commands=====</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 9: Laravel Fundamentals - Raw SQL Queries</h1>
            <p>
              <h1 class="MasterBoxTitle">====39. Inserting data====</h1>
              <pre>
              ...
              <h1 class="MasterBoxTitle">====40. Reading Data====</h1>
              <pre>
                <strong class="ProceduralProcessBoxTitle">step 1</strong> : <b>In web.php(Routes)</b>
              ...
              <h1 class="MasterBoxTitle">====41. Updating Data====</h1>
              <pre>
                <strong class="ProceduralProcessBoxTitle">step 1</strong> : <b>In web.php(Routes)</b>
              ...
              <h1 class="MasterBoxTitle">====42. Deleting Data====</h1>
              <pre>
                <strong class="ProceduralProcessBoxTitle">step 1</strong> : <b>In web.php(Routes)</b>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 10: Laravel Fundamentals - Database - Eloquent/ORM</h1>
              <p>
                <h1 class="MasterBoxTitle">===44. Reading Data===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===45. Reading / Finding with Constraints===</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 11: Laravel Fundamentals - Database - Eloquent Relationships</h1>
            <div class="section11">
              <p>
                <h1 class="MasterBoxTitle">===56. One to One relationship===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle" style="background:red">===57. The inverse relation===</h1>
                ...
                <h1 class="MasterBoxTitle">===58. One to many relationship===</h1>
                ...
                <h1 class="MasterBoxTitle"style="background:red">===60-61. Many to many relations Pivot Tables - To Relate Other Tables (OrToRelate Those 2 Tables)===</h1>
                ...
                <h1 class="MasterBoxTitle">62. Querying intermediate table</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:<b></b>
                </pre>
                <h1 class="MasterBoxTitle">63-64. Has many through relation</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">65-66. Polymorphic relation</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>
                ...
                <h1 class="MasterBoxTitle">67. Polymorphic relation the inverse - REVIEW </h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">68-69. Polymorphic relation many to many</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">70. Polymorphic relation many to many - retrieving</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">71. Polymorphic relation many to many - retrieving owner</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong> <b></b>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 12: Laravel Fundamentals - Database - Tinker</h1>
            <div class="section12">
              <p>
                <h1 class="MasterBoxTitle">===73. Creating data with tinker===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">74. Finding record and using constraints in tinker</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:
              ...
              &rsaquo;&rsaquo;                $table->integer('user_id')->unsigned();  &lsaquo;&lsaquo; <b class="takeNote">NOTE</b>: When you want to find the id of a table automatically in Laravel just
                ...
                <h1 class="MasterBoxTitle">79. Database configuration and migration (Master Prac: OneToOne Relationships)</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 14: Database - Eloquent One to Many Relationship CRUD</h1>
            <div class="section12">
              <p>
                <h1 class="MasterBoxTitle">===85. Database migrations===</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 15: Database - Eloquent Many to Many Relationship CRUD</h1>
            <div class="section15">
              <p>
                <h1 class="MasterBoxTitle">92. Database migrations</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:<b></b>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 16: Database - Eloquent Polymorphic Relationship CRUD</h1>
            <div class="section16">
              <p>
                <h1 class="MasterBoxTitle">100. Relationships and mass assignment</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 17: Database - Eloquent Polymorphic Many to Many Relationship CRUD</h1>
            <div class="divConChildsOfSection section17">
              <p>
                <h1 class="MasterBoxTitle">===107. Relationships and mass assignment===</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Section 18: Forms and Validation</h1>
            <div class="divConChildsOfSection" id="section18">
              <p>
                <h1 class="MasterBoxTitle">112. Setting up migration and relations</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <div class="divConChildsOfSection youtube_surfside_media_2">
              <p>
                <h1 class="MasterBoxTitle">======1-Laravel 8 Tutorial - Installation======</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:
                ...
                <h1 class="MasterBoxTitle">======2-Laravel 8 Tutorial - Routing======</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===3-Laravel 8 Tutorial - Controllers===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===4-Laravel 8 Tutorial - Views===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===5-Laravel 8 Tutorial - Blade Components===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">===6-Laravel 8 Tutorial - HTTP Client===</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">7-Laravel 8 Tutorial - Fluent Strings</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">8-Laravel 8 Tutorial - Stub Customization</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">9-Laravel 8 Tutorial - HTTP Requests and Html Form</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">10-Laravel 8 Tutorial - Form Validation</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">11-Laravel 8 Tutorial - Middleware</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">12-Laravel 8 Tutorial - Http Session</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">13-Laravel 8 Tutorial - Start with Database</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">14-Laravel 8 Tutorial - Database Query Builder and CRUD Operation</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">15-Laravel 8 Tutorial - Join Clauses</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">16-Laravel 8 Tutorial - Model</h1>
                <pre>
                  <strong class="ProceduralProcessBoxTitle">step 1</strong>:
                ...
                <h1 class="MasterBoxTitle">17-Laravel 8 Tutorial - Migration</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">18-Laravel 8 Tutorial - Seeding</h1>
                <pre>
                ...
                <h1 class="MasterBoxTitle">19-Laravel 8 Tutorial - Blade Template</h1> <a target="_blank" href="https://laravel.com/docs/8.x/blade">Detailed Documentation</a>
                <pre>
                ...
                <h1 class="MasterBoxTitle">20-Laravel 8 Tutorial - Blade Template Layout <a target="_blank" href="https://laravel.com/docs/8.x/blade">Detailed Documentation</a></h1>
                <pre>
                  <b class="steprocedure">1</b>
                  Create layout
          ...
          <section class="sectionDivisions">
            <h1 class="LectureSectionMasterTitle">Laravel Extra: Using Vue.js with Laravel</h1>

            <div class="divConChildsOfSection">
              <p>
                ...
                <h1 class="MasterBoxTitle">Learning Vue.js</h1>
                <pre>
                </pre>
              </p>
            </div>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci2">------------Code Inspire 2-Installing AdminLTE 3 on Laravel 5.7 and Bootstrap 4------------</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <h1 class="MasterBoxTitle" id="ci6">Learning Points 31 Laravel PDF</h1>
              <p>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci6">Code Inspire 6-Configure Vue Router to Laravel 5.7 and Admin LTE 3</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci7">Code Inspire 7-Detect Active Menu in Vue Router and Laravel Plus HTML5 History Mode</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci11">Code Inspire 11-Using VFrom for Back-end Error Handling in Laravel and Vuejs</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci12">Code Inspire 12-API Resource Controller in Laravel 5.7 with Vuejs</h1>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci13">Code Inspire 13-Insert User Data to Database Using Axios in Laravel 5.7 and Vue</h1>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci14">Code Inspire 14-😇 Nice Server Validation with Laravel and Vue js (handle with vForm)</h1>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci15">Code Inspire 15-Display Users from Database in Table Using Axios in Laravel and Vue</h1>
                <strong class="ProceduralProcessBoxTitle">Step 1</strong>:Laravel PHP PART app\Http\Controllers\<b class="highlights">API\UserController.php</b></em></b>
                <pre>
                  <div class="codeManagement">
                    public function index() {
              ...
              <h1 class="MasterBoxTitle" id="ci16">Code Inspire 16-Global Vuejs Filters and Momentjs Instead of Carbon in Laravel and Vue</h1>
              ...
              <h1 class="MasterBoxTitle">CI 17-ProgressBar with Vuejs and Laravel When Create new Record with Ajax.===</h1>
              <section class="sectionDivision">
              ...
              <h1 class="MasterBoxTitle">CI 18-Sweet Alert in Laravel 5.7 and Vue after Ajax Request</h1>
              <section class="sectionDivision">
                <div class="containerContentManagementDivision">
                  <p>
                    <h2 class="moduleContentBoxTitle" id=""></h2>
              ...
              <h1 class="MasterBoxTitle">===CI 19-Send HTTP Request Every 3 Seconds to Update Data in Laravel and Vuejs===</h1>
              <section class="sectionDivision">
                <div class="containerContentManagementDivision">
                  <p>
                    <h2 class="moduleContentBoxTitle" id=""></h2>
              ...
              <h1 class="MasterBoxTitle">===CI 20-Use Custom Event to Send HTTP Request After You Create the User in Laravel and Vuejs===</h1>
              <section class="sectionDivision">
                <div class="containerContentManagementDivision">
                  <p>
                    <h2 class="moduleContentBoxTitle" id=""></h2>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci42">Code Inspire 42-Easily Add ACL to Laravel Without Extra Tables in Database</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci43">Code Inspire 43-Limited Access to Controllers Using ACL in Laravel</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci44-laraACL">Code Inspire 44-Laravel 5.7 ACL in Front-end Using Vue js</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci45">Code Inspire 45-Design 404 Page for  Front-End If User Doesn't Have Access</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci46">Code Inspire 46-How User and Author Can Have The Same Access Level in Laravel 5.7 Front-end and Back-end</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci47">Code Inspire 47-Laravel and Vuejs Pagination Best Packages</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci48">Code Inspire 48-Laravel 5.7 and Vuejs Ajax Pagination</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci49">Code Inspire 49-Review - What Else We Need to Add for Our Laravel + Vue App -</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci50">Code Inspire 50-Vue Router 404 Page with Laravel 5.7</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci51">Code Inspire 51-Re-Usable Search Functionality in Laravel 5.7 and Vuejs ( Ajax, Axios )</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci52">Code Inspire 52-Instant Search With Laravel and Vuejs  Use ( Debounce )</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci53">Code Inspire 53-Print Invoice as PDF in Laravel using JavaScript</h1>
                <pre>
            ...
            <div class="divConChildsOfSection">
              <p>
                <h1 class="MasterBoxTitle" id="ci44-laraACL">Code Inspire 54-How to Use Laravel + Vuejs Starter Template  ( Wrap-up and New Series)</h1>
                <pre>
          ...
          <section class="sectionDivisions">
            <h1 id="noted-lec-of-non-poly-db-relationships" class="LectureSectionMasterTitle">Laravel Database Relationsips</h1>

            <div class="divConChildsOfSection">
              <p>
                <a href=""></a>

                <h1 class="MasterBoxTitle">Section 12: Laravel Fundamentals - Database - Tinker</h1>
                <pre>
                  <div class="codeManagement">
                    php artisan tinker
                ...
                <h1 class="MasterBoxTitle">Section 11: Laravel Fundamentals - Database - Eloquent</h1>
                <pre>
                  <div class="codeManagement">
                    <blockquote cite="http://">
...
">Link 2</a>
        ...
        $(function () {
          ...
          $(".divConChildsOfSection").css({
            position: `relative`,

          })

          $(".LectureSectionMasterTitle").css({
            "text-align":`center`,
