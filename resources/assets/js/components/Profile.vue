        ...
        <div class="card">
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#activity" data-toggle="tab"></a>
              </li>
              ...
              <div class="tab-pane active show" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <textarea class="form-control" id="inputExperienceID" placeholder="Experience" :class="{ 'is-invalid': profileForm.errors.has('bio') }"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="file" id="photo-id-attr" @change="updateProfilePhoto" name="photo_name_attr" class="form-input">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input v-model="profileForm.password" type="passpord" class="form-control" :class="{ 'is-invalid': profileForm.errors.has('password') }" id="passportID" placeholder="Passport">
                    </div>
                  </div>
